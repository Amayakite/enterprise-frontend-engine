      ...
      data: [
        {
          ...
          children: [
            ...
            {
              path: "sale/add",
              component: "base/sale/add",
              name: "SaleAdd",
              meta: { title: "新增销售组织", hidden: true, keepAlive: true },
            },
            {
              path: "sale/edit/:id",
              component: "base/sale/edit",
              name: "SaleEdit",
              meta: { title: "编辑销售组织", hidden: true, keepAlive: true },
            },
            {
              path: "sale/detail/:id",
              component: "base/sale/detail",
              name: "SaleDetail",
              meta: { title: "销售组织详情", hidden: true, keepAlive: true },
            },
            {
              path: "customer",
            ...
            {
              path: "customer/add",
              component: "base/customer/add",
              name: "CustomerAdd",
              meta: { title: "新增客户", hidden: true, keepAlive: true },
            },
            {
              path: "customer/edit/:id",
              component: "base/customer/edit",
              name: "CustomerEdit",
              meta: { title: "编辑客户", hidden: true, keepAlive: true },
            },
            {
              path: "customer/detail/:id",
              component: "base/customer/detail",
              name: "CustomerDetail",
              meta: { title: "客户详情", hidden: true, keepAlive: true },
            },
          ],
        },
        {
          ...
          children: [
            ...
            {
              path: "fee/add",
              component: "task/fee/add",
              name: "TaskFeeAdd",
              meta: { title: "新增任务费用", hidden: true, keepAlive: true },
            },
            {
              path: "fee/edit/:id",
              component: "task/fee/edit",
              name: "TaskFeeEdit",
              meta: { title: "编辑任务费用", hidden: true, keepAlive: true },
            },
            {
              path: "fee/detail/:id",
              component: "task/fee/detail",
              name: "TaskFeeDetail",
              meta: { title: "任务费用详情", hidden: true, keepAlive: true },
            },
            {
              path: "meeting-application",
              component: "task/meeting-application/index",
            ...
            {
              path: "meeting-application/edit/:id?",
              component: "task/meeting-application/edit",
              name: "MeetingApplicationEdit",
              meta: {
                title: "编辑会议申请",
                icon: "",
                hidden: true,
            ...
            {
              path: "meeting-application/detail/:id",
              component: "task/meeting-application/detail",
              name: "MeetingApplicationDetail",
              meta: {
                title: "会议申请详情",
                icon: "",
                hidden: true,
        ...
        },
        {
          ...
          children: [
            {
              path: "application",
              component: "service/application/index",
