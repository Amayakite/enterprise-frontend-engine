    ...
    body: {
      ...
      data: {
        ...
        perms: [
          ...
          "base:customer:approve",
          "base:customer:revoke",
          "base:customer:enable",
          "base:customer:disable",
          "task:fee:list",
          "task:fee:create",
          "task:fee:update",
          "task:fee:delete",
          ...
          "service:application:update",
          "service:application:delete",
          "service:application:approve",
          "service:application:revoke",

          "task:meeting-application:list",
          "task:meeting-application:create",
          "task:meeting-application:update",
          "task:meeting-application:delete",
          "task:meeting-application:submit",
          "task:meeting-application:approve",
          "task:meeting-application:revoke",
